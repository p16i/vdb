...
class Net(BaseNet):
    def __init__(self, architecture, in_shape, num_class, cov_type,  batch_norm=True, beta=1e-3, M=1):
        ...
        # References for resnet_v1
        # n=3 is resnet20
        # n=7 is resnet44
        # n=18 is resnet110
        self.encoder = resnet_v1(
            input_shape=in_shape,
            depth=architecture["n"] * 6 + 2,
            num_classes=self.parameters_for_latent,
        )

# Code below is taken (and slightly adapted) from https://keras.io/examples/cifar10_resnet/
